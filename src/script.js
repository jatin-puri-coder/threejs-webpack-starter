...
const normaltexture = textureLoader.load('/textures/T2.jpeg')
...
const pointLight = new THREE.PointLight(0x33aaff, 0.1)
...
pointLight2.position.set(2.88, 0.72, -5)
...
light1.add(pointLight2.position, 'y').min(-8).max(8).step(0.01)
...
//Light 3
const pointLight3 = new THREE.PointLight(0x97de17, 2)
pointLight3.position.set(-1.75, -2.46, -5)
pointLight3.intensity = 16
